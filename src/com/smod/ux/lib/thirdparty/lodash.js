...
(function () {
	...
	var runInContext = (function runInContext(context) {
		...
		function baseWhile(array, predicate, isDrop, fromRight) {
			...
			return isDrop ? baseSlice(array, (fromRight ? 0 : index), (fromRight ? index + 1 : length)) : baseSlice(array, (fromRight ? index + 1 :
				0), (fromRight ? length : index));
		}
		...
		function equalArrays(array, other, bitmask, customizer, equalFunc, stack) {
			...
			while (++index < arrLength) {
				...
				if (customizer) {
					var compared = isPartial ? customizer(othValue, arrValue, index, other, array, stack) : customizer(arrValue, othValue, index, array,
						other, stack);
				}
