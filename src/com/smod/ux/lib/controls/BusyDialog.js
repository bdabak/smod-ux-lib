...
sap.ui.define(
  ...
  function (
     ...
     * <ul>
     * <li>The screen is not supposed to be blocked. Use a {@link com.smod.ux.lib.controls.BusyIndicator} for the specific application part.</li>
     ...
     *
     * @public
     * @alias com.smod.ux.lib.controls.BusyDialog
     */
    var BusyDialog = Control.extend(
      "com.smod.ux.lib.controls.BusyDialog",
      /** @lends com.smod.ux.lib.controls.BusyDialog.prototype */ {
        metadata: {
          library: "com.smod.ux.lib.controls",
          properties: {
            /**
    ...
    BusyDialog.prototype.init = function () {
      ...
      jQuery.sap.includeStyleSheet(sLibraryPath + "/controls/BusyDialog.css");
